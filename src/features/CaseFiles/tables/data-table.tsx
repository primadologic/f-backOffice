                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuGroup>
                      ...
                      <DropdownMenuGroup>
                        ...
                        {["opened", "investigation", "review", "approved", "closed", "archived"].map((statusOption) => {
                          const column = table.getColumn("status");
                          const currentFilter = column?.getFilterValue() as string | undefined;
                          const isChecked = currentFilter === statusOption;
                          ...
                          <DropdownMenuCheckboxItem
                            ...
                            onCheckedChange={(checked) => {
                              if (!column) return;
                              column.setFilterValue(checked ? statusOption : undefined) // Set or Clear filter
                            }}
                            >
                              { statusOption }
                            </DropdownMenuCheckboxItem>

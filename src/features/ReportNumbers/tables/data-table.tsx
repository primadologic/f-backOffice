      ...
      <Card className="rounded-[1.8rem] border">
        <div className="w-full flex flex-row justify-between items-center">
          <CardHeader className="">
            <CardTitle className="text-xl font-semibold">Report Numbers List</CardTitle>
            <CardDescription>Keep track of reported fraud incidents and other information</CardDescription>
          </CardHeader>

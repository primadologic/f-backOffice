...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const refreshAccessToken = async () => {
    ...
    try {
      ...
      Cookies.set("access", accessToken, { expires: 30 / 1440, secure: true, sameSite: "Strict" });
  ...
  const login = (newToken: string, refreshToken: string) => {
    ...
    Cookies.set("access", newToken, { expires: accessTokenExpiresInDays, secure: true, sameSite: "Strict" });
    Cookies.set("refresh", refreshToken, { expires: refreshExpiresInDays, secure: true, sameSite: "Strict" }); 
